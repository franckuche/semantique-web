...
columns = ["keyword", "Nb de mots suggérés", "Volume de recherches", "headings_thruuu", "Mots / concepts importants à développer"]
...
# Si des données sont présentes dans le DataFrame
if not data.empty:

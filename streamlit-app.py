...
if uploaded_file and api_key_1 and api_key_2 and api_key_3:
    ...
    for index, row in data.iterrows():
        ...
        if prompt_option == "Semantique IA":
            ...
            prompt_text = "Veuillez insérer ici votre propre texte de prompt pour l'option 'Géoloc IA'."
        elif prompt_option == "Business IA":
            prompt_text = "Veuillez insérer ici votre propre texte de prompt pour l'option 'Business IA'."
    messages = [

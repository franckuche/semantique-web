...
if writing_style_option != "Pas de choix":
    writing_style_prompt = prompt_options[writing_style_option]
...
if generate_content:
    ...
    for index, row in df.iterrows():
        ...
        if writing_style_option != "Pas de choix":
            prompt_text_2 = f"{structure_hn} Veuillez écrire un article basé sur cette structure en utilisant le style de rédaction '{writing_style_option}'."
            messages_2 = [
